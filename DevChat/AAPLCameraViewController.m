...
//Át kellet nevezni a previewView-t _previewView-ra mert ugyan az lett volna a neve majd a program többi részében is át kellett nevezni + át kellett helyezni a headerbe, mert Objective-C-ben így teszem publikossá.
...
//Létrehoztunk Egy CameraVCDelegate-t hogy tudjuk használni ebben a faljban az Apple által már megirt function-oket, igy nem veszitjuk el oket
//Objective-C-be kellett írni mert swift-el nem mukodott, nem tudtunk hivatkozni ra
...
//IBAction-t kitöröltem void-ot irtam be és kitöröltem az (id)sender
